...
public class UpdateCategory extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("/Views/ViewsManager/updateCategory.jsp").forward(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int count = dao.countUsersOrderedProduct(id);
            ...
            if (count > 0) {
                ...
                request.setAttribute("category", c);
                request.setAttribute("error", "Hiện có: " + count + " khách hàng đang có giao dịch nên không thể cập nhật.");
                request.getRequestDispatcher("/Views/ViewsManager/updateCategory.jsp").forward(request, response);
                return;
            }
