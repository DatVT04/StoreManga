...
public class ViewCart extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int totalCartbyUsername = cd.countProductsInCartByUsername(username);
            session.setAttribute("countCart", totalCartbyUsername);

           CartDao cdao = new CartDao(); 
         List<Cart> c = cdao.getAllByUsername(username);
            if (c.isEmpty()) {
                request.setAttribute("error", "Danh sách giỏ hàng trống.");
            } else {
            ...
            request.getRequestDispatcher("/Views/ViewsShoping/Cart.jsp").forward(request, response);
