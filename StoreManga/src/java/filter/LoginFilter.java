...
public class LoginFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        String homepageUrl = contextPath + "/home";
        ...
        boolean isSignUpRequest = url.equals(contextPath + "/signup");
        ...
        if (isLoggedIn && isLoginRequest || isLoggedIn && isSignUpRequest) {
            res.sendRedirect(homepageUrl);
            return;
        }

        if (!isLoggedIn && (url.contains("/addCart")
                || url.contains("/viewCart")
                || url.contains("/profile")
                || url.contains("/changepass")
                || url.contains("/status")
